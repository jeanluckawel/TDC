            ...
            <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                <nav>
                    <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                        ...
                        <li><a id="about"  class="inline-block no-underline hover:text-black hover:underline py-2 px-4" >About</a></li>
                        <li><a id="haut">hhh</a></li>
                    </ul>
                </nav>
            </div>
    ...
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80" alt="picture">
                    <a href="#">
                    ...
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">L4 GL</p>
                        <p class="">November 13/2023</p>
                    </div>
                    <p class="pt-1 text-gray-900">Paul Kaf</p>
                    <p>Read</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80" alt="picture">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">How create your Business</h5>
                    </a>
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">L4 MSI</p>
                        <p class="">November 13/2023</p>
                    </div>
                    <p class="pt-1 text-gray-900">Aisha Aisha</p>
                    <p>Read</p>
                </a>
            </div>
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    <img class="hover:grow hover:shadow-lg" src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80" alt="picture">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Safety.io</h5>
                    </a>
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">L4 GL</p>
                        <p class="">November 13/2023</p>
                    </div>
                    <p class="pt-1 text-gray-900">Jl Kawel</p>
                    <p>Read</p>
                </a>
            </div>
